...
Table \@ref(tab:table1) above includes the summary statistics of the data on insurance distribution in the US. It shows that a majority of the population is covered under Employer-Provided Insurance with a mean of `r round(sum_stat$mean[1])` and the second-most coverage is provided by Medicaid with a mean of `r round(sum_stat$mean[3])` over the years and across all states. 
